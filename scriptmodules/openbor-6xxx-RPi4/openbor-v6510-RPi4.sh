...
rp_module_id="openbor-v6510-RPi4"
...
function install_openbor-v6510-RPi4() {
    md_ret_files=(
       'OpenBOR'
       'libGL.so.1'
    )
...
function configure_openbor-v6510-RPi4() {
